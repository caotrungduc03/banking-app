...
import { IconWallet, IconDeviceFloppy, IconNfc } from '@tabler/icons-react';
import { useAuth } from '../hooks/useAuth';
import { isNFCSupported, startNFCScanning, writeNFCData, processNFCPayment } from '../services/nfc';
      ...
      {userData ? (
        <>
          <Card withBorder shadow="sm" radius="md" mb="lg">
            ...
            <Divider my="sm" />
            <Text size="sm">
              Account Holder: {userData.displayName || 'User'}
            </Text>
            <Text size="sm">
          ...
          >
            <Stack align="center" gap="md">
              ...
              {nfcScanStatus === 'success' && (
                <>
                  <Text fw={500} c="green">Payment successful!</Text>
              ...
              {nfcScanStatus === 'error' && (
                <>
                  <Text fw={500} c="red">Payment failed</Text>
            ...
            {nfcWriteStatus === 'idle' || nfcWriteStatus === 'error' ? (
              ...
              <Stack align="center" gap="md">
                ...
                {nfcWriteStatus === 'success' && (
                  <>
                    <Text fw={500} c="green">NFC tag written successfully!</Text>
